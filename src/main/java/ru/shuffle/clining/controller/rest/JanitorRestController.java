...
import ru.shuffle.clining.dao.JanitorDao;
import ru.shuffle.clining.entity.Janitor;
import ru.shuffle.clining.service.JanitorImageService;
...
@Tag(name = "Контроллер, обеспечивающий работу с работниками")
public class JanitorRestController {
        ...
        @GetMapping("/all")
        public List<Janitor> getJanitorList(Model model, HttpSession httpSession) {
...
//            model.addAttribute("janitors", janitorService.addListForMainPage());
            return janitorService.addListForMainPage();
        }
